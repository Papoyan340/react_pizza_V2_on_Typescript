...
import { setCategoruId, setPageCount, setFilters, selectfilter } from '../redux/slices/filterSlice';
...
function Home() {
   ...
   const { categoryId, sort, pageCount, searcValue } = useSelector(selectfilter);
   const { dataPizzas, status } = useSelector(selectPizzas);
   ...
   const getPizzas = async () => {
      ...
      dispatch(fetchPizzas({ category, order, sortBy, search, pageCount }));
